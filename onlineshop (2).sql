...
INSERT INTO `pengiriman` (`id_pengiriman`, `id_pesanan`, `alamat_tujuan`, `tanggal_pengiriman`, `status_pengiriman`, `kurir`) VALUES
(1, 1, 'Jl. Mawar 123', '2024-01-02', 'Dikirim', 'JNE'),
(2, 2, 'Jl. Melati 456', '2024-01-03', 'Selesai', 'SiCepat'),
(3, 3, 'Jl. Anggrek 789', '2024-01-04', 'Selesai', 'J&T'),
(4, 4, 'Jl. Kenanga 101', '2024-01-05', 'Dikirim', 'GrabExpress'),
(5, 5, 'Jl. Cemara 202', '2024-01-06', 'Pending', 'Gojek'),
(6, 6, 'Jl. Tulip 303', '2024-01-07', 'Selesai', 'JNE'),
(7, 7, 'Jl. Flamboyan 404', '2024-01-08', 'Dikirim', 'SiCepat'),
(8, 8, 'Jl. Sakura 505', '2024-01-09', 'Pending', 'J&T'),
(9, 9, 'Jl. Teratai 606', '2024-01-10', 'Selesai', 'GrabExpress'),
(10, 10, 'Jl. Dahlia 707', '2024-01-11', 'Selesai', 'Gojek'),
(11, 11, 'Jl. Cempaka 808', '2024-01-12', 'Dikirim', 'JNE'),
(12, 12, 'Jl. Jasmine 909', '2024-01-13', 'Selesai', 'SiCepat'),
(13, 13, 'Jl. Nusa Indah 010', '2024-01-14', 'Pending', 'J&T'),
(14, 14, 'Jl. Puspa 111', '2024-01-15', 'Dikirim', 'GrabExpress'),
(15, 15, 'Jl. Bakung 212', '2024-01-16', 'Selesai', 'Gojek'),
(16, 16, 'Jl. Mawar Biru 313', '2024-01-17', 'Dikirim', 'JNE'),
(17, 17, 'Jl. Melati Kuning 414', '2024-01-18', 'Pending', 'SiCepat'),
(18, 18, 'Jl. Anggrek Putih 515', '2024-01-19', 'Selesai', 'J&T'),
(19, 19, 'Jl. Cemara Hijau 616', '2024-01-20', 'Selesai', 'GrabExpress'),
(20, 20, 'Jl. Dahlia Merah 717', '2024-01-21', 'Pending', 'Gojek');
...
INSERT INTO `pesanan` (`id_pesanan`, `id_pelanggan`, `id_pembayaran`, `tanggal_pesanan`, `total_harga`, `status_pesanan`, `metode_pembayaran`) VALUES
(1, 1, 1, '2024-01-01', 7500000, 'Sukses', 'Transfer Bank'),
(2, 2, 2, '2024-01-02', 2500000, 'Sukses', 'COD'),
(3, 3, 3, '2024-01-03', 10000000, 'Pending', 'Kartu Kredit'),
(4, 4, 4, '2024-01-04', 5000000, 'Sukses', 'e-Wallet'),
(5, 5, 5, '2024-01-05', 300000, 'Sukses', 'Transfer Bank'),
(6, 6, 6, '2024-01-06', 15000000, 'Pending', 'Kartu Kredit'),
(7, 7, 7, '2024-01-07', 7000000, 'Gagal', 'Transfer Bank'),
(8, 8, 8, '2024-01-08', 2500000, 'Sukses', 'COD'),
(9, 9, 9, '2024-01-09', 500000, 'Pending', 'e-Wallet'),
(10, 10, 10, '2024-01-10', 300000, 'Sukses', 'Kartu Kredit'),
(11, 11, 11, '2024-01-11', 150000, 'Sukses', 'COD'),
(12, 12, 12, '2024-01-12', 10000000, 'Pending', 'Transfer Bank'),
(13, 13, 13, '2024-01-13', 800000, 'Sukses', 'e-Wallet'),
(14, 14, 14, '2024-01-14', 500000, 'Pending', 'Kartu Kredit'),
(15, 15, 15, '2024-01-15', 7000000, 'Sukses', 'COD'),
(16, 16, 16, '2024-01-16', 1200000, 'Pending', 'Transfer Bank'),
(17, 17, 17, '2024-01-17', 250000, 'Sukses', 'e-Wallet'),
(18, 18, 18, '2024-01-18', 1000000, 'Pending', 'Kartu Kredit'),
(19, 19, 19, '2024-01-19', 15000000, 'Sukses', 'Transfer Bank'),
(20, 20, 20, '2024-01-20', 5000000, 'Pending', 'COD');
...
('U001', 1, 1, 5, 'Produk sangat bagus, sesuai ekspektasi!', '2024-01-03'),
('U002', 2, 2, 4, 'Pengiriman cepat, tapi kemasan kurang rapi.', '2024-01-04'),
('U003', 3, 3, 3, 'Produk oke, tapi ada sedikit cacat.', '2024-01-05'),
('U004', 4, 4, 5, 'Harga sesuai dengan kualitas. Sangat puas!', '2024-01-06'),
('U005', 5, 5, 2, 'Produk tidak sesuai deskripsi.', '2024-01-07'),
('U006', 6, 6, 4, 'Cukup memuaskan, tapi masih bisa lebih baik.', '2024-01-08'),
('U007', 7, 7, 5, 'Layanan pelanggan sangat responsif.', '2024-01-09'),
('U008', 8, 8, 3, 'Pengiriman terlalu lama, produk oke.', '2024-01-10'),
('U009', 9, 9, 1, 'Sangat kecewa, produk rusak.', '2024-01-11'),
('U010', 10, 10, 4, 'Produk bagus, tapi stok terbatas.', '2024-01-12'),
('U011', 11, 11, 5, 'Belanja di sini sangat menyenangkan!', '2024-01-13'),
('U012', 12, 12, 3, 'Kurir tidak ramah, tapi produk oke.', '2024-01-14'),
('U013', 13, 13, 2, 'Harga terlalu mahal untuk kualitas ini.', '2024-01-15'),
('U014', 14, 14, 5, 'Kualitas terbaik, sangat direkomendasikan!', '2024-01-16'),
('U015', 15, 15, 4, 'Produk sesuai dengan deskripsi.', '2024-01-17'),
('U016', 16, 16, 5, 'Sangat puas dengan layanan dan produk!', '2024-01-18'),
('U017', 17, 17, 1, 'Pengalaman belanja buruk, tidak akan kembali.', '2024-01-19'),
('U018', 18, 18, 3, 'Produk biasa saja, harga agak mahal.', '2024-01-20'),
('U019', 19, 19, 5, 'Kualitas premium dengan harga terjangkau.', '2024-01-21'),
('U020', 20, 20, 4, 'Belanja mudah, produk memuaskan.', '2024-01-22');
...
ALTER TABLE `pesanan`
  ...
  ADD KEY `id_pelanggan` (`id_pelanggan`,`id_pembayaran`),
  ADD KEY `id_pelanggan_2` (`id_pelanggan`,`id_pembayaran`);
